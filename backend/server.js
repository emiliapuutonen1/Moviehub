...
const pool = new Pool({
  user: 'netuser',
  host: process.env.RENDER_DB_HOSTNAME || 'dpg-clsb5crip8as739pjtl0-a.oregon-postgres.render.com',
  database: 'moviehub_mdo1',
  password: process.env.RENDER_DB_PASSWORD || '94gtgU16Dx4t5fryapjg1QHGTXRlYNDo',
  port: 5432,
  ssl: {
