...
*/
const renderDBHostname = process.env.RENDER_DB_HOSTNAME;
const renderDBPassword = process.env.RENDER_DB_PASSWORD;

const pool = new Pool({
  user: 'netuser', // Replace with your Render database username
  host: renderDBHostname, // Use the environment variable for Render database hostname
  database: 'moviehub_mdo1',
  password: renderDBPassword, // Use the environment variable for Render database password
  port: 5432,
  ssl: {
    rejectUnauthorized: false,
  },
